...
class GITHUB{
    constructor(){
        this.client_id='418afbb6cbbc1c0bcbe0';
this.client_secret='4d06685780725a13f07fb6b39f8fdf828e08a444';
...
class UI{
    ...
    getUser(user){
      ...
      if(message === 'Not Found'){
          this.showFeedback('no such user exist,Plz enter different value')
      }
    else{
